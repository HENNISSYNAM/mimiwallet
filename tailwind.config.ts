  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        // The `kapiva-*` alias that used to live here is gone. It existed to
        // catch stray classes left over from the rename; src/ now has none, so
        // it was only emitting the old brand into the compiled stylesheet.
