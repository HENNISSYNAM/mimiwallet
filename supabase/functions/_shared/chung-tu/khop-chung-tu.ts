 ...
 *
 * MỘT BẢN CHO CẢ HAI PHÍA. Chuyển từ `src/lib/khopChungTu.ts` về đây ngày 15/09/2026 để
 * màn Chứng từ chi phí và MIMI Assistant (edge function `tro-ly`) ghép bằng đúng một
 * định nghĩa. Hai bản chép tay sẽ cho hai con số "chưa có giấy tờ" khác nhau trên hai
 * màn hình — đúng loại lệch dữ liệu người dùng đã phàn nàn. `src/lib/khopChungTu.ts`
 * giờ chỉ xuất lại file này. File không được import gì để trình duyệt và Deno cùng đọc.
 *
