const m = {
  ob: {
    ...
    createAccountSub: 'Bắt đầu hành trình vốn thông minh cùng KAPIVA',
    ...
    ekycConfirmPrefix: 'Tôi xác nhận thông tin chính xác và đồng ý cho KAPIVA xử lý dữ liệu theo',
    back: '← Quay lại',
    skip: 'Bỏ qua →',
